...
//    This file is part of OpenPS3FTP. (https://github.com/jjolano/openps3ftp)
...
int ftp_init()
{
	...
	sys_ppu_thread_create(&thread_id, handleconnections, (u64)list_s, 1500, 0x400, 0, "ConnectionHandler");
	
	sprintf(ftp_ip_str, "FTP active (%s:%i)", ipaddr, port);
